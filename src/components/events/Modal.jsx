...
const Modal = ({ events, setEvents }) => {
  return (
    <div className="font-playfair fixed top-[56%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75vw] md:w-[50vw] isa-yellow z-10 drop-shadow-lg">
      ...
      <div className="p-3">
        <p className="m-0 pl-2">{events.location}</p>
